...
import { autenticar, exigirAdministrador } from "../middlewares/authMiddleware.js";
...
// ROTAS PROTEGIDAS
// ======================================
router.post("/gatos", validate(authHeadersSchema), autenticar, exigirAdministrador, validate(gatoBodySchema), postGato);
router.put("/gatos/:id", validate(authHeadersSchema), autenticar, exigirAdministrador, validate(gatoParamsAndBodySchema), putGato);
router.delete("/gatos/:id", validate(authHeadersSchema), autenticar, exigirAdministrador, validate(gatoParamsSchema), deleteGato);
